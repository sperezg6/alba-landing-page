...
// Metal Button Types and Variants
type ColorVariant =
  | "default"
  | "primary"
  | "success"
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-[var(--color-primary)] via-[var(--color-primary-dark)] to-[var(--color-primary)]",
    button: "bg-gradient-to-b from-[var(--color-primary)] to-[var(--color-primary-dark)]",
    textColor: "text-white",
